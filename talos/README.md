...
```
export CTL1_IP=192.168.50.178
export WRK1_IP=192.168.50.82
export WRK2_IP=192.168.50.82
export WRK3_IP=192.168.50.82

talosctl get disks --insecure --nodes $CTL1_IP
talosctl get disks --insecure --nodes $WRK1_IP
talosctl get disks --insecure --nodes $WRK2_IP
talosctl get disks --insecure --nodes $WRK3_IP
